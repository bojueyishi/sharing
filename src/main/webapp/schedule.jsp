		...
		<div class="am-u-sm-12 am-u-md-6">
			<div class="am-btn-toolbar">
				<div class="am-btn-group am-btn-group-xs">
					<button type="button" new class="am-btn am-btn-default">
						<span class="am-icon-plus"></span> 新增
					</button>
					<button type="button" delete class="am-btn am-btn-default">
	...
	<div class="am-popup" id="editor-popup">
		<div class="am-popup-inner">
			<div class="am-popup-hd">
				<h4 class="am-popup-title">编辑 / Editor</h4>
						...
						<dd class="am-accordion-bd am-collapse ">
							<div class="am-accordion-content">
								<ul class="am-list admin-content-file">
									...
									<li>结束时间: <input type="text" endTime class="am-form-field"
